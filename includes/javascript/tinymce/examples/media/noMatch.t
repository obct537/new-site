...
<a name="l00116"></a>00116 <span class="comment"> * guarentee that it will compress the file into sparse segments</span>
...
<a name="l00281"></a>00281                                         <a class="code" href="group__apr__file__info.html#ga3af19c4c47007169064a70f9351bc7d8">apr_fileperms_t</a> perms,
<a name="l00282"></a>00282                                         <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00297"></a>00297                                           <a class="code" href="group__apr__file__info.html#ga3af19c4c47007169064a70f9351bc7d8">apr_fileperms_t</a> perms,
<a name="l00298"></a>00298                                           <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00323"></a>00323                                                <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00333"></a>00333                                                <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00343"></a>00343                                               <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00358"></a>00358                                                      <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00373"></a>00373                                                      <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00388"></a>00388                                                      <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00543"></a>00543                                         <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *thefile);
...
<a name="l00566"></a>00566                                        <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *old_file,
<a name="l00567"></a>00567                                        <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *p);
...
<a name="l00578"></a>00578                                         <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *old_file,
<a name="l00579"></a>00579                                         <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *p);
...
<a name="l00593"></a>00593                                             <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *old_file,
<a name="l00594"></a>00594                                             <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *p);
...
<a name="l00648"></a>00648                                                <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> **out,
<a name="l00649"></a>00649                                                <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00671"></a>00671 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#gac365ab74c583eb1df5cd05660a81b5c8">apr_file_pipe_create_ex</a>(<a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> **in, 
<a name="l00672"></a>00672                                                   <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> **out, 
<a name="l00673"></a>00673                                                   apr_int32_t blocking, 
<a name="l00674"></a>00674                                                   <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *p);
...
<a name="l00683"></a>00683                                                     <a class="code" href="group__apr__file__info.html#ga3af19c4c47007169064a70f9351bc7d8">apr_fileperms_t</a> perm, 
<a name="l00684"></a>00684                                                     <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
...
<a name="l00692"></a>00692                                                <a class="code" href="group__apr__time.html#gaae2129185a395cc393f76fabf4f43e47">apr_interval_time_t</a> *timeout);
<a name="l00693"></a>00693 <span class="comment"></span>
<a name="l00694"></a>00694 <span class="comment">/**</span>
<a name="l00695"></a>00695 <span class="comment"> * Set the timeout value for a pipe or manipulate the blocking state.</span>
<a name="l00696"></a>00696 <span class="comment"> * @param thepipe The pipe we are setting a timeout on.</span>
<a name="l00697"></a>00697 <span class="comment"> * @param timeout The timeout value in microseconds.  Values &lt; 0 mean wait </span>
<a name="l00698"></a>00698 <span class="comment"> *        forever, 0 means do not wait at all.</span>
...
<a name="l00701"></a>00701                                                   <a class="code" href="group__apr__time.html#gaae2129185a395cc393f76fabf4f43e47">apr_interval_time_t</a> timeout);
<a name="l00702"></a>00702 <span class="comment"></span>
<a name="l00703"></a>00703 <span class="comment">/** file (un)locking functions. */</span>
<a name="l00704"></a>00704 <span class="comment"></span>
<a name="l00705"></a>00705 <span class="comment">/**</span>
<a name="l00706"></a>00706 <span class="comment"> * Establish a lock on the specified, open file. The lock may be advisory</span>
<a name="l00707"></a>00707 <span class="comment"> * or mandatory, at the discretion of the platform. The lock applies to</span>
<a name="l00708"></a>00708 <span class="comment"> * the file as a whole, rather than a specific range. Locks are established</span>
<a name="l00709"></a>00709 <span class="comment"> * on a per-thread/process basis; a second lock by the same thread will not</span>
<a name="l00710"></a>00710 <span class="comment"> * block.</span>
<a name="l00711"></a>00711 <span class="comment"> * @param thefile The file to lock.</span>
<a name="l00712"></a>00712 <span class="comment"> * @param type The type of lock to establish on the file.</span>
...
<a name="l00717"></a>00717 <span class="comment"> * Remove any outstanding locks on the file.</span>
<a name="l00718"></a>00718 <span class="comment"> * @param thefile The file to unlock.</span>
<a name="l00719"></a>00719 <span class="comment"> */</span>
<a name="l00720"></a>00720 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#ga3a255996fb439b6d66ed7cd65319525b">apr_file_unlock</a>(<a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *thefile);
<a name="l00721"></a>00721 <span class="comment"></span>
<a name="l00722"></a>00722 <span class="comment">/**accessor and general file_io functions. */</span>
<a name="l00723"></a>00723 <span class="comment"></span>
<a name="l00724"></a>00724 <span class="comment">/**</span>
<a name="l00725"></a>00725 <span class="comment"> * return the file name of the current file.</span>
<a name="l00726"></a>00726 <span class="comment"> * @param new_path The path of the file.  </span>
<a name="l00727"></a>00727 <span class="comment"> * @param thefile The currently open file.</span>
...
<a name="l00730"></a>00730                                             <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *thefile);
<a name="l00731"></a>00731     <span class="comment"></span>
<a name="l00732"></a>00732 <span class="comment">/**</span>
<a name="l00733"></a>00733 <span class="comment"> * Return the data associated with the current file.</span>
<a name="l00734"></a>00734 <span class="comment"> * @param data The user data associated with the file.  </span>
<a name="l00735"></a>00735 <span class="comment"> * @param key The key to use for retreiving data associated with this file.</span>
<a name="l00736"></a>00736 <span class="comment"> * @param file The currently open file.</span>
...
<a name="l00739"></a>00739                                             <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *file);
<a name="l00740"></a>00740 <span class="comment"></span>
<a name="l00741"></a>00741 <span class="comment">/**</span>
<a name="l00742"></a>00742 <span class="comment"> * Set the data associated with the current file.</span>
<a name="l00743"></a>00743 <span class="comment"> * @param file The currently open file.</span>
<a name="l00744"></a>00744 <span class="comment"> * @param data The user data to associate with the file.  </span>
<a name="l00745"></a>00745 <span class="comment"> * @param key The key to use for assocaiteing data with the file.</span>
<a name="l00746"></a>00746 <span class="comment"> * @param cleanup The cleanup routine to use when the file is destroyed.</span>
<a name="l00747"></a>00747 <span class="comment"> */</span>                     
<a name="l00748"></a>00748 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#ga58c857162593d8b3aa999df5b7af0805">apr_file_data_set</a>(<a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *file, <span class="keywordtype">void</span> *data,
<a name="l00749"></a>00749                                             const <span class="keywordtype">char</span> *key,
<a name="l00750"></a>00750                                             <a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a> (*cleanup)(<span class="keywordtype">void</span> *));
<a name="l00751"></a>00751 <span class="comment"></span>
<a name="l00752"></a>00752 <span class="comment">/**</span>
<a name="l00753"></a>00753 <span class="comment"> * Write a string to a file using a printf format.</span>
<a name="l00754"></a>00754 <span class="comment"> * @param fptr The file to write to.</span>
<a name="l00755"></a>00755 <span class="comment"> * @param format The format string</span>
<a name="l00756"></a>00756 <span class="comment"> * @param ... The values to substitute in the format string</span>
<a name="l00757"></a>00757 <span class="comment"> * @return The number of bytes written</span>
...
<a name="l00760"></a>00760                                         const <span class="keywordtype">char</span> *format, ...)
<a name="l00761"></a>00761         __attribute__((format(printf,2,3)));
<a name="l00762"></a>00762 <span class="comment"></span>
<a name="l00763"></a>00763 <span class="comment">/**</span>
<a name="l00764"></a>00764 <span class="comment"> * set the specified file&#39;s permission bits.</span>
<a name="l00765"></a>00765 <span class="comment"> * @param fname The file (name) to apply the permissions to.</span>
<a name="l00766"></a>00766 <span class="comment"> * @param perms The permission bits to apply to the file.</span>
<a name="l00767"></a>00767 <span class="comment"> *</span>
<a name="l00768"></a>00768 <span class="comment"> * @warning Some platforms may not be able to apply all of the</span>
<a name="l00769"></a>00769 <span class="comment"> * available permission bits; APR_INCOMPLETE will be returned if some</span>
<a name="l00770"></a>00770 <span class="comment"> * permissions are specified which could not be set.</span>
<a name="l00771"></a>00771 <span class="comment"> *</span>
<a name="l00772"></a>00772 <span class="comment"> * @warning Platforms which do not implement this feature will return</span>
<a name="l00773"></a>00773 <span class="comment"> * APR_ENOTIMPL.</span>
<a name="l00774"></a>00774 <span class="comment"> */</span>
<a name="l00775"></a>00775 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#gac5fed6d75597476718c40fc603823b1e">apr_file_perms_set</a>(const <span class="keywordtype">char</span> *fname,
<a name="l00776"></a>00776                                              <a class="code" href="group__apr__file__info.html#ga3af19c4c47007169064a70f9351bc7d8">apr_fileperms_t</a> perms);
<a name="l00777"></a>00777 <span class="comment"></span>
<a name="l00778"></a>00778 <span class="comment">/**</span>
<a name="l00779"></a>00779 <span class="comment"> * Set attributes of the specified file.</span>
<a name="l00780"></a>00780 <span class="comment"> * @param fname The full path to the file (using / on all systems)</span>
<a name="l00781"></a>00781 <span class="comment"> * @param attributes Or&#39;d combination of</span>
<a name="l00782"></a>00782 <span class="comment"> * &lt;PRE&gt;</span>
<a name="l00783"></a>00783 <span class="comment"> *            APR_FILE_ATTR_READONLY   - make the file readonly</span>
<a name="l00784"></a>00784 <span class="comment"> *            APR_FILE_ATTR_EXECUTABLE - make the file executable</span>
<a name="l00785"></a>00785 <span class="comment"> *            APR_FILE_ATTR_HIDDEN     - make the file hidden</span>
<a name="l00786"></a>00786 <span class="comment"> * &lt;/PRE&gt;</span>
<a name="l00787"></a>00787 <span class="comment"> * @param attr_mask Mask of valid bits in attributes.</span>
<a name="l00788"></a>00788 <span class="comment"> * @param pool the pool to use.</span>
<a name="l00789"></a>00789 <span class="comment"> * @remark This function should be used in preference to explict manipulation</span>
<a name="l00790"></a>00790 <span class="comment"> *      of the file permissions, because the operations to provide these</span>
<a name="l00791"></a>00791 <span class="comment"> *      attributes are platform specific and may involve more than simply</span>
<a name="l00792"></a>00792 <span class="comment"> *      setting permission bits.</span>
...
<a name="l00797"></a>00797                                              apr_fileattrs_t attributes,
<a name="l00798"></a>00798                                              apr_fileattrs_t attr_mask,
<a name="l00799"></a>00799                                              <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
<a name="l00800"></a>00800 <span class="comment"></span>
<a name="l00801"></a>00801 <span class="comment">/**</span>
<a name="l00802"></a>00802 <span class="comment"> * Set the mtime of the specified file.</span>
<a name="l00803"></a>00803 <span class="comment"> * @param fname The full path to the file (using / on all systems)</span>
<a name="l00804"></a>00804 <span class="comment"> * @param mtime The mtime to apply to the file.</span>
<a name="l00805"></a>00805 <span class="comment"> * @param pool The pool to use.</span>
<a name="l00806"></a>00806 <span class="comment"> * @warning Platforms which do not implement this feature will return</span>
<a name="l00807"></a>00807 <span class="comment"> *      APR_ENOTIMPL.</span>
...
<a name="l00810"></a>00810                                              <a class="code" href="group__apr__time.html#gadb4bde16055748190eae190c55aa02bb">apr_time_t</a> mtime,
<a name="l00811"></a>00811                                              <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
<a name="l00812"></a>00812 <span class="comment"></span>
<a name="l00813"></a>00813 <span class="comment">/**</span>
<a name="l00814"></a>00814 <span class="comment"> * Create a new directory on the file system.</span>
<a name="l00815"></a>00815 <span class="comment"> * @param path the path for the directory to be created. (use / on all systems)</span>
<a name="l00816"></a>00816 <span class="comment"> * @param perm Permissions for the new direcoty.</span>
<a name="l00817"></a>00817 <span class="comment"> * @param pool the pool to use.</span>
...
<a name="l00820"></a>00820                                        <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
<a name="l00821"></a>00821 <span class="comment"></span>
<a name="l00822"></a>00822 <span class="comment">/** Creates a new directory on the file system, but behaves like</span>
<a name="l00823"></a>00823 <span class="comment"> * &#39;mkdir -p&#39;. Creates intermediate directories as required. No error</span>
<a name="l00824"></a>00824 <span class="comment"> * will be reported if PATH already exists.</span>
<a name="l00825"></a>00825 <span class="comment"> * @param path the path for the directory to be created. (use / on all systems)</span>
<a name="l00826"></a>00826 <span class="comment"> * @param perm Permissions for the new direcoty.</span>
<a name="l00827"></a>00827 <span class="comment"> * @param pool the pool to use.</span>
...
<a name="l00830"></a>00830                                                  <a class="code" href="group__apr__file__info.html#ga3af19c4c47007169064a70f9351bc7d8">apr_fileperms_t</a> perm,
<a name="l00831"></a>00831                                                  <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *pool);
<a name="l00832"></a>00832 <span class="comment"></span>
<a name="l00833"></a>00833 <span class="comment">/**</span>
<a name="l00834"></a>00834 <span class="comment"> * Remove directory from the file system.</span>
<a name="l00835"></a>00835 <span class="comment"> * @param path the path for the directory to be removed. (use / on all systems)</span>
<a name="l00836"></a>00836 <span class="comment"> * @param pool the pool to use.</span>
<a name="l00837"></a>00837 <span class="comment"> * @remark Removing a directory which is in-use (e.g., the current working</span>
<a name="l00838"></a>00838 <span class="comment"> * directory, or during apr_dir_read, or with an open file) is not portable.</span>
...
<a name="l00843"></a>00843 <span class="comment"> * get the specified file&#39;s stats.</span>
<a name="l00844"></a>00844 <span class="comment"> * @param finfo Where to store the information about the file.</span>
<a name="l00845"></a>00845 <span class="comment"> * @param wanted The desired apr_finfo_t fields, as a bit flag of APR_FINFO_ values </span>
<a name="l00846"></a>00846 <span class="comment"> * @param thefile The file to get information about.</span>
<a name="l00847"></a>00847 <span class="comment"> */</span> 
<a name="l00848"></a>00848 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#ga39be7fe05d0dda4a28f4358b61a44ac8">apr_file_info_get</a>(<a class="code" href="structapr__finfo__t.html">apr_finfo_t</a> *finfo, 
<a name="l00849"></a>00849                                             apr_int32_t wanted,
<a name="l00850"></a>00850                                             <a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *thefile);
<a name="l00851"></a>00851     
<a name="l00852"></a>00852 <span class="comment"></span>
<a name="l00853"></a>00853 <span class="comment">/**</span>
<a name="l00854"></a>00854 <span class="comment"> * Truncate the file&#39;s length to the specified offset</span>
<a name="l00855"></a>00855 <span class="comment"> * @param fp The file to truncate</span>
<a name="l00856"></a>00856 <span class="comment"> * @param offset The offset to truncate to.</span>
<a name="l00857"></a>00857 <span class="comment"> * @remark The read/write file offset is repositioned to offset.</span>
<a name="l00858"></a>00858 <span class="comment"> */</span>
<a name="l00859"></a>00859 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#gac067fe5f208c927cf6d213197b9335a8">apr_file_trunc</a>(<a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *fp, apr_off_t offset);
<a name="l00860"></a>00860 <span class="comment"></span>
<a name="l00861"></a>00861 <span class="comment">/**</span>
<a name="l00862"></a>00862 <span class="comment"> * Retrieve the flags that were passed into apr_file_open()</span>
<a name="l00863"></a>00863 <span class="comment"> * when the file was opened.</span>
<a name="l00864"></a>00864 <span class="comment"> * @return apr_int32_t the flags</span>
<a name="l00865"></a>00865 <span class="comment"> */</span>
<a name="l00866"></a>00866 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(apr_int32_t) <a class="code" href="group__apr__file__io.html#ga023d6e4d2512382a9d4b1f881e105b8f">apr_file_flags_get</a>(<a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> *f);
<a name="l00867"></a>00867 <span class="comment"></span>
<a name="l00868"></a>00868 <span class="comment">/**</span>
<a name="l00869"></a>00869 <span class="comment"> * Get the pool used by the file.</span>
<a name="l00870"></a>00870 <span class="comment"> */</span>
<a name="l00871"></a>00871 <a class="code" href="group__apr__pools.html#ga89ce1d55c7f0c39ea87c88eabd655394">APR_POOL_DECLARE_ACCESSOR</a>(file);
<a name="l00872"></a>00872 <span class="comment"></span>
<a name="l00873"></a>00873 <span class="comment">/**</span>
<a name="l00874"></a>00874 <span class="comment"> * Set a file to be inherited by child processes.</span>
<a name="l00875"></a>00875 <span class="comment"> *</span>
<a name="l00876"></a>00876 <span class="comment"> */</span>
<a name="l00877"></a>00877 <a class="code" href="apr__inherit_8h.html#aa67d345784df8cce8114086e1f67cf3d">APR_DECLARE_INHERIT_SET</a>(file);
<a name="l00878"></a>00878 <span class="comment"></span>
<a name="l00879"></a>00879 <span class="comment">/**</span>
<a name="l00880"></a>00880 <span class="comment"> * Unset a file from being inherited by child processes.</span>
<a name="l00881"></a>00881 <span class="comment"> */</span>
<a name="l00882"></a>00882 <a class="code" href="apr__inherit_8h.html#ad4886be514d6cead6bd119a48984d4b5">APR_DECLARE_INHERIT_UNSET</a>(file);
<a name="l00883"></a>00883 <span class="comment"></span>
<a name="l00884"></a>00884 <span class="comment">/**</span>
<a name="l00885"></a>00885 <span class="comment"> * Open a temporary file</span>
<a name="l00886"></a>00886 <span class="comment"> * @param fp The apr file to use as a temporary file.</span>
<a name="l00887"></a>00887 <span class="comment"> * @param templ The template to use when creating a temp file.</span>
<a name="l00888"></a>00888 <span class="comment"> * @param flags The flags to open the file with. If this is zero,</span>
<a name="l00889"></a>00889 <span class="comment"> *              the file is opened with </span>
<a name="l00890"></a>00890 <span class="comment"> *              APR_CREATE | APR_READ | APR_WRITE | APR_EXCL | APR_DELONCLOSE</span>
<a name="l00891"></a>00891 <span class="comment"> * @param p The pool to allocate the file out of.</span>
<a name="l00892"></a>00892 <span class="comment"> * @remark   </span>
<a name="l00893"></a>00893 <span class="comment"> * This function  generates  a unique temporary file name from template.  </span>
<a name="l00894"></a>00894 <span class="comment"> * The last six characters of template must be XXXXXX and these are replaced </span>
<a name="l00895"></a>00895 <span class="comment"> * with a string that makes the filename unique. Since it will  be  modified,</span>
<a name="l00896"></a>00896 <span class="comment"> * template must not be a string constant, but should be declared as a character</span>
<a name="l00897"></a>00897 <span class="comment"> * array.  </span>
<a name="l00898"></a>00898 <span class="comment"> *</span>
<a name="l00899"></a>00899 <span class="comment"> */</span>
<a name="l00900"></a>00900 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#gac34981f9ff41f85e4377a6dde185fe52">apr_file_mktemp</a>(<a class="code" href="group__apr__file__io.html#gaa46e4763ac375ea3c7a43ba6f6099e22">apr_file_t</a> **fp, <span class="keywordtype">char</span> *templ,
<a name="l00901"></a>00901                                           apr_int32_t flags, <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *p);
<a name="l00902"></a>00902 
<a name="l00903"></a>00903 <span class="comment"></span>
<a name="l00904"></a>00904 <span class="comment">/**</span>
<a name="l00905"></a>00905 <span class="comment"> * Find an existing directory suitable as a temporary storage location.</span>
<a name="l00906"></a>00906 <span class="comment"> * @param temp_dir The temp directory.</span>
<a name="l00907"></a>00907 <span class="comment"> * @param p The pool to use for any necessary allocations.</span>
<a name="l00908"></a>00908 <span class="comment"> * @remark   </span>
<a name="l00909"></a>00909 <span class="comment"> * This function uses an algorithm to search for a directory that an</span>
<a name="l00910"></a>00910 <span class="comment"> * an application can use for temporary storage.</span>
<a name="l00911"></a>00911 <span class="comment"> *</span>
<a name="l00912"></a>00912 <span class="comment"> */</span>
<a name="l00913"></a>00913 <a class="code" href="group__apr__platform.html#gad7b91b811a172bfa802603c2fb688f98">APR_DECLARE</a>(<a class="code" href="group__apr__errno.html#gaf76ee4543247e9fb3f3546203e590a6c">apr_status_t</a>) <a class="code" href="group__apr__file__io.html#ga5cc19828a668c362be0ad7a12b805cc0">apr_temp_dir_get</a>(const <span class="keywordtype">char</span> **temp_dir, 
<a name="l00914"></a>00914                                            <a class="code" href="group__apr__pools.html#gaf137f28edcf9a086cd6bc36c20d7cdfb">apr_pool_t</a> *p);
<a name="l00915"></a>00915 <span class="comment"></span>
<a name="l00916"></a>00916 <span class="comment">/** @} */</span>
<a name="l00917"></a>00917 
<a name="l00918"></a>00918 <span class="preprocessor">#ifdef __cplusplus</span>
...
<a name="l00922"></a>00922 <span class="preprocessor">#endif  </span><span class="comment">/* ! APR_FILE_IO_H */</span>
</pre></div></div>
